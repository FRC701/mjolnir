...
{
  dA.WhileHeld(new SlingShot(1.0));
  dB.WhileHeld(new SlingShot(-1.0));
  dX.WhileHeld(new SetSlingEngagement);
  dY.WhileHeld(new SetSlingDisengagement);

  SmartDashboard::PutData("PuncherButton", new SlingShot(1.0));
  SmartDashboard::PutData("CalibrateArm", new Calibrate);
}
