...
void Robot::TeleopPeriodic() {
	...
	SmartDashboard::PutNumber("PDP Current 14", mPdp.GetCurrent(14));//Right Side
  SmartDashboard::PutNumber("PDP Current 15", mPdp.GetCurrent(15));//Right Side
  SmartDashboard::PutNumber("PDP Current 0", mPdp.GetCurrent(0));//Left Side
  SmartDashboard::PutNumber("PDP Current 1", mPdp.GetCurrent(1));//Left Side
 ...
 */
  ...
  if((Intake::getInstance()->IsIntakeOn()) && ! rumbled){
    if(!rumbling){
      rumbler.Start();
  ...
  if(!Intake::getInstance()->IsIntakeOn()) {
   OI::getInstance()->SetRumble(0.0);
   rumbling = false;
   rumbled = false;
   rumbler.Stop();
