...
#include "Commands/AutoLeftSwitchAll.h"
...
void Robot::RobotInit() {
	...
	chooser->AddDefault("Twiddle Your Thumbs", new AutonomousCommand());
	chooser->AddObject("Switch", new AutoSwitchSelector(new AutoLeftSwitchAll(), new AutoRightSwitch()));
